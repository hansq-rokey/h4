...
APP_NAME="papabear-order-service"
#JAVA虚拟机参数设置
...
start(){
 ...
 showprogress
 JAVA_OPTS="$JAVA_OPTS "
 #exec $JAVA $JAVA_OPTS -Djava.ext.dirs=./  -jar papabear-order-service.jar &
 nohup $JAVA $JAVA_OPTS -Djava.ext.dirs=./  -jar papabear-order-service.jar > stdout.log 2>&1 &
